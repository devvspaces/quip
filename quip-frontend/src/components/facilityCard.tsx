import Healthcare, { OperationalStatus } from "@/helpers/interface";
import { get_google_maps_link } from "@/helpers/utils";
...
export default function FacilityCard({ facility }: { facility: Healthcare }) {
  ...
  const locationUrl =
    facility.latitude && facility.longitude
      ? get_google_maps_link(facility.latitude, facility.longitude)
      : "#";
      ...
      >
        ...
        <HStack align={"center"} justify={"center"} mt={6} wrap={"wrap"}>
          ...
          <Badge
            ...
            py={1}
            colorScheme={
              facility.operationalStatus === "Operational" ? "green" : "red"
            }
            fontWeight={"400"}
          >
            {facility.operationalStatus}
          </Badge>
          {facility.hoursOfOperation.join(",") && (
            <Badge px={2} py={1} bg={badgeColor} fontWeight={"400"}>
              {facility.hoursOfOperation.join(",")}
            </Badge>
          )}
        ...
        <Stack mt={8} direction={"row"} spacing={4} justify={"center"}>
          ...
          {facility.website && (
            <Link isExternal href={facility.website}>
              <Button
                fontSize={"sm"}
                rounded={"full"}
                bg={"blue.400"}
              ...
              <AccordionItem>
                ...
                >
                  ...
                  <LrCustom
                    ...
                    value={
                      <Link
                        isExternal={Boolean(facility.website)}
                        href={locationUrl}
                      >
                        <IconButton
                          aria-label="phone"
              ...
              <AccordionItem>
                ...
                >
                  ...
                  <LrCustom
                    ...
                    value={
                      <Link
                        href={facility.email ? `mail:+${facility.email}` : "#"}
                      >
                        <IconButton
                          aria-label="phone"
                          icon={<FiMail />}
                  ...
                  <LrCustom
                    ...
                    value={
                      <Link
                        isExternal={Boolean(facility.website)}
                        href={facility.website ? facility.website : "#"}
                      >
                        <IconButton
                          aria-label="phone"
                          icon={<CgWebsite />}
